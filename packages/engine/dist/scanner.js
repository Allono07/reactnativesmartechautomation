...
export async function scanProject(rootPath) {
    ...
    const nativeAndroidManifestPath = path.join(rootPath, "app", "src", "main", "AndroidManifest.xml");
    ...
    const hasNativeAndroidRoot = (await pathExists(nativeAndroidAppPath)) &&
    ...
    const hasAndroidModuleRoot = (await pathExists(androidModuleManifestPath)) &&
